...
export default function Login() {
    ...
    return (
      <View>
        <Button
          ...
          customStyle={
            disableButton
              ? Styles.bottomDisable.innerContainer
              : Styles.bottomEnable.innerContainer
          }
          labelStyle={
            disableButton
              ? Styles.bottomDisable.label
              : Styles.bottomEnable.label
          }
          onSubmit={() => postLogin()}
          loading={loading}
        />
  ...
  return (
    <Base renderHeader={renderHeader()} renderBottom={renderBottom()}>
      {renderForm()}
    </Base>
  );
}
